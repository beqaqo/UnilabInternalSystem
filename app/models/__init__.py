...
from app.models.announcement import ActivityType, Announcement, AnnouncementUser, AnnouncementForm, AnnouncementLecturer
from app.models.user import User, Country, Region, City, University, Certificate
