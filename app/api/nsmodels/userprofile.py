...
profile_parser.add_argument("name", required=True, type=str, help="Name example: Roma (1-50 characters)")
profile_parser.add_argument("lastname", required=True, type=str, help="Last name example: Grigalashhvili ")
profile_parser.add_argument("email", required=True, type=str, help="Email example: example@gmail.com ")
...
profile_parser.add_argument("date", required=True, type=inputs.datetime_from_iso8601, help="Date of birth example: 1999-10-27")
profile_parser.add_argument("gender", required=True, type=str, help="Gender example: Male/Female")
profile_parser.add_argument("password", required=True, type=str, help="Password example: password123 ")
profile_parser.add_argument("password_new", required=True, type=str, help="New password (Should not match password)")
